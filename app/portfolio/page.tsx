    ...
    <main style={{ background: 'var(--bg)', color: 'var(--text)', fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6, WebkitFontSmoothing: 'antialiased', minHeight: '100vh' }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cs-arch-cta-text p { font-size: 0.84rem; color: var(--faint); margin-top: 4px; }
        .cs-arch-cta-text strong { font-size: 1rem; color: var(--text); }
      ...
      <section className="cs-section" id="work">
        <div className="cs-inner">
          ...
          <div className="cs-arch-cta">
            <div className="cs-arch-cta-text">
              <strong>Want to see every technical decision explained?</strong>
              <p>Full system architecture — stack rationale, layer diagram, order flow, and every technology choice.</p>
            </div>
            <a href="/architecture" className="btn-secondary">Explore the Architecture &rarr;</a>
          </div>
        </div>
      </section>

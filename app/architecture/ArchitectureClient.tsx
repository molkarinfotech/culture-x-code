    ...
    <main style={{ background: 'var(--bg)', color: 'var(--text)', fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6, WebkitFontSmoothing: 'antialiased', minHeight: '100vh' }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .arch-nav-links { display: flex; gap: 32px; list-style: none; align-items: center; }
        .arch-nav-links a {
        ...
        .arch-nav-right { display: flex; align-items: center; gap: 12px; }
        .theme-toggle {
        ...
        .arch-hero h1 {
          ...
          margin-bottom: 24px; max-width: 800px; color: var(--text);
        }
        ...
        .tab-bar {
          ...
          padding: 0 60px; background: var(--surface);
        ...
        .section-title {
          ...
          font-weight: 700; line-height: 1.15; margin-bottom: 16px; max-width: 640px;
          color: var(--text);
        }
        .section-desc {
        ...
        .layer-number {
          ...
          color: var(--border-strong); min-width: 32px;
        }
        ...
        .chip {
          padding: 7px 14px; background: var(--tag-bg); color: var(--tag-text);
        ...
        .flow-step:not(:last-child)::after {
          ...
          transform: translateY(-50%); color: var(--accent); font-size: 1rem;
          z-index: 2; background: var(--surface); padding: 4px 2px;
        }
        .flow-step-num {
        ...
        .compare-list li::before {
          ...
          color: var(--accent); font-size: 0.75rem; top: 2px;
        }
        ...
        .admin-url {
          ...
          border-radius: 4px; padding: 5px 12px; font-size: 0.75rem;
          color: var(--muted); text-align: center; letter-spacing: 0.01em;
        }
        ...
        .admin-nav-item {
          ...
          padding: 8px 20px; font-size: 0.8rem; color: var(--muted);
        }
        .admin-nav-item.active {
          border-left: 2px solid var(--accent); color: var(--accent);
          background: var(--accent-light); padding-left: 18px;
        }
        ...
        .status-live { background: var(--tag-bg); color: var(--accent); }
        .status-out { background: rgba(220,38,38,0.1); color: #dc2626; }
        .status-review { background: rgba(180,130,0,0.1); color: #b48200; }

        /* ADMIN FEATURES */
        .admin-feature-grid {
          display: grid; grid-template-columns: repeat(3, 1fr);
          gap: 2px; background: var(--border); margin-top: 3px;
        }
        ...
        /* CTA */
        .arch-cta { text-align: center; padding: 100px 60px; }
        .arch-cta h2 {
          font-family: var(--font-display);
          font-size: clamp(2rem, 4vw, 3.2rem);
          font-weight: 700; margin-bottom: 20px; line-height: 1.1; color: var(--text);
        }
      ...
      <section className="arch-hero">
        ...
        <div className="arch-hero-links">
          ...
          <a href="/#work" className="btn-secondary">Back to Case Study</a>
        </div>
      </section>

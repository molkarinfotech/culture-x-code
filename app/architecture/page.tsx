...
export const metadata: Metadata = {
  title: 'Architecture — Ethnic Story Feature Map',
  description:
    'Interactive feature map of the Ethnic Story platform — main website, admin portal, and full tech stack breakdown.',
}
...
export default function ArchitecturePage() {
  ...
  return (
    <main style={{ background: '#0a0a0a', color: '#f0ede8', fontFamily: "'DM Sans', sans-serif", fontSize: '16px', lineHeight: 1.6, WebkitFontSmoothing: 'antialiased', minHeight: '100vh' }}>
      <style>{`
        @import url('${fontUrl}');
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-btn {
          padding: 9px 20px; background: var(--accent); color: #0a0a0a;
          border: none; border-radius: 4px; font-size: 0.8rem; font-weight: 700;
        ...
        .hero-back {
          ...
          border: 1px solid var(--border); padding: 11px 22px; border-radius: 4px;
        }
        ...
        .tab-bar {
          ...
          background: var(--border); border-radius: 4px 4px 0 0; overflow: hidden;
        }
        .tab-btn {
        ...
        .flow-node {
          flex: 1; background: var(--surface); padding: 24px 16px;
        ...
        .flow-node:not(:last-child)::after {
          ...
          background: var(--surface); padding: 2px 3px; line-height: 1;
        }
        .flow-node-icon {
        ...
        .feature-card-id {
          ...
          color: rgba(201,169,110,0.18); line-height: 1; margin-bottom: 12px;
        }
        .feature-card-title {
          font-size: 0.95rem; font-weight: 600; color: var(--text); margin-bottom: 9px;
        }
        .feature-card-desc {
          font-size: 0.85rem; color: var(--muted); line-height: 1.72;
          margin-bottom: 14px;
        }
        .tag {
        ...
        .chip {
          padding: 5px 13px; background: var(--tag-bg); color: var(--tag-text);
        ...
        .admin-card-desc {
          font-size: 0.85rem; color: var(--muted); line-height: 1.72; margin-bottom: 14px;
        }
        .admin-card-items { display: flex; flex-direction: column; gap: 5px; }
        .admin-card-item {
          font-size: 0.8rem; color: var(--muted);
          padding-left: 15px; position: relative; line-height: 1.55;
        }
        .admin-card-item::before {
          content: '—'; position: absolute; left: 0;
          color: var(--accent); font-size: 0.65rem; top: 3px;
        }
        ...
        .kpi-value {
          ...
          font-weight: 700; color: var(--text); line-height: 1; margin-bottom: 7px;
        }
        ...
        .stack-name {
          font-size: 0.95rem; font-weight: 600; color: var(--text); margin-bottom: 7px;
        }
        .stack-desc {
          font-size: 0.82rem; color: var(--muted); line-height: 1.68;
        }
      ...
      <div className="tabs-wrapper">
        <div className="tab-bar" role="tablist">
          <button className="tab-btn active" role="tab" aria-selected="true"  aria-controls="panel-main"  id="tab-main"  onClick="switchTab('main')" >Main Website</button>
          <button className="tab-btn"        role="tab" aria-selected="false" aria-controls="panel-admin" id="tab-admin" onClick="switchTab('admin')">Admin Portal</button>
          <button className="tab-btn"        role="tab" aria-selected="false" aria-controls="panel-stack" id="tab-stack" onClick="switchTab('stack')">Tech Stack</button>
        </div>

        {/* ── PANEL 1: MAIN WEBSITE ── */}
        <div className="tab-panel active" id="panel-main" role="tabpanel" aria-labelledby="tab-main">

          <div className="panel-section" style={{ marginTop: '2px' }}>
            <div className="panel-label">User Flow</div>
            <div className="flow-row">
              {([
                ['M','Discovery','Browse & Search'],
                ['M','Product','View details'],
                ['M','Cart','Add & review'],
                ['M','Checkout','Stripe payment'],
                ['M','Confirmed','Order placed'],
              ] as [string,string,string][]).map(([,title,sub], i) => (
        ...
        <div className="tab-panel" id="panel-admin" role="tabpanel" aria-labelledby="tab-admin">
          ...
          <div className="panel-section">
            ...
            <div className="table-wrap">
              <table>
                <thead>
                  <tr>
                    {['SKU','Product Name','Category','Stock','Status'].map(h => (
                      <th key={h}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {([
                    ...
                    <tr key={sku}>
                      ...
                      <td className="td-stock">{stock}</td>
                      <td>
        ...
        {/* ── PANEL 3: TECH STACK ── */}
        <div className="tab-panel" id="panel-stack" role="tabpanel" aria-labelledby="tab-stack">
